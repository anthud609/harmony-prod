...
// Get the ConfigManager instance to use its env() method
...
return [
    ...
    */
    ...
    'name' => $config->env('APP_NAME', 'Harmony HRMS'),
    ...
    */
    ...
    'aliases' => [
        'Config' => App\Core\Config\ConfigManager::class,
        'Session' => App\Core\Security\SessionManager::class,
        'CSRF' => App\Core\Security\CsrfProtection::class,
    ],
